...
variables = {
	...
	"SITE-DOMAINS": {
		"value": "",
		"required": "false",
        "description":"List of Domains of the sites to test, split by comma(,)."
	},
	"SITE-WORDLIST": {
		"value": "",
		"required": "false",
        "description":"Path of Domain file of the sites to test."
	}
}
description = "Will check if .git is accessible and try to gather as much info from it as possible"
