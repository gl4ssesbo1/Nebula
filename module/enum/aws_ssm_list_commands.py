...
variables = {
    ...
    "COMMAND-ID": {
        "value": "",
        "required": "false",
        "description":"If provided, lists only the specified command."
    },
    "INSTANCE-ID": {
        "value": "",
        "required": "false",
    ...
    "DOCUMENTNAME": {
        "value": "",
        "required": "false",
        "description":"Lists commands issued using a specific Document."
    },
    "STATUS": {
        "value": "",
        "required": "false",
...
def exploit(profile, workspace):
    try:
        ...
        file = "{}_ssm_list_commands".format(dt_string)
